...
- [x] Step 3 — Technical design (`specs/design.md`, approved 2026-07-20; amended 2026-07-21 with D16–D20). Engine evaluation completed via six prototype sessions (evidence: `prototypes/engine-eval/`); OQ-1/OQ-7 resolved (mypy 2.3.0 / Python); OQ-2 and OQ-4 deliberately remain open until the viewer milestone.
